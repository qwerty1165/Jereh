...
public class GetPurchaseInQueryDetailServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetPurchaseInQueryDetailServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<PurchaseInQueryDetail> pdList = pdService.getPurchaseInQuery(xcode);
