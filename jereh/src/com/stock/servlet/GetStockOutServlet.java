...
public class GetStockOutServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		PageBean pb=service.getStockOutList(code, customerName, date1, date2, Integer.parseInt(pageNo), Integer.parseInt(pageSize));
		...
		System.out.println("³ö¿â¡ª¡ª¡ª¡ª"+data);
